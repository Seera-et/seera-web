...
import { getArticles, getCorpusStats, getDocument, listDocuments } from './documents'
import { getHealth } from './health'
import type { ArticlePage, DocumentQuery } from './types'
...
export const queryKeys = {
  ...
  articles: (id: string, versionId: string | null) =>
    ['documents', 'articles', id, versionId] as const,
 ...
 */
export function useArticles(documentId: string, versionId: string | null) {
  return useInfiniteQuery({
    queryKey: queryKeys.articles(documentId, versionId),
